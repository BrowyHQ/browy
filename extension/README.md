...
| `permission denied` / backend never connects on macOS | Gatekeeper quarantine on the downloaded install | `xattr -dr com.apple.quarantine ~/.browy/app` (the installer does this automatically since 0.1.6) |
